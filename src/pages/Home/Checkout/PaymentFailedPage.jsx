...
import { Container, Box, Card, CardContent, Button, Typography, Alert, AlertTitle } from '@mui/material';
              ...
              <Box className="space-y-6">
                ...
                <Box className="space-y-4">
                  <Box className="flex justify-between items-center p-4 bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl">
                    ...
                    <Typography className="font-bold text-gray-700">Premium 3 tháng</Typography>
                  </Box>
